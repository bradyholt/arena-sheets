...
function SpreadsheetManager(oauth2) {
  ...
  this.drive = google.drive({ version: 'v2', auth: oauth2});
}
...
SpreadsheetManager.prototype.prepSheet = function(name, templateId) {
    var _this = this;

    var promise = new Promise(function(resolve,reject) {
        _this.getId(name, templateId)
            .then(function(id) {
                Worksheets.load({
                    debug: true,
                    spreadsheetId: id,

...
exports.readData = function(dataPath, classId, lastSundayDate) {
    ...
    if (attendanceData && attendanceData.length){
        ...
        logger.info("Attendance date columns determined", {class_id: classId, datesStartColumnIndex: datesStartColumnIndex, datesEndColumnIndex: datesEndColumnIndex});
        ...
        logger.info("Attendance dates loaded", {class_id: classId, dates: dates});

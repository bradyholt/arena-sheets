        ...
        spreadsheet.metadata({
          ...
          colCount: newColumnCount
            ...
            if (err) {
                ...
                logger.info("Will overwrite worksheet with new data", { class_id: classId, worksheetName: worksheetName});
                spreadsheet.send(function(err) {
                    if (err) {
                        logger.error("Error when overwriting worksheet", { class_id: classId, worksheetName: worksheetName, error: err});
                    } else {
                        logger.info("Worksheet updated", { class_id: classId, worksheetName: worksheetName});
                    }
                });
            }
        });
            ...
            spreadsheet.metadata({
              ...
              colCount: newColumnCount
                ...
                if (err) {
                    ...
                    logger.info("Will prepend worksheet with new data", { class_id: classId, worksheetName: worksheetName});
